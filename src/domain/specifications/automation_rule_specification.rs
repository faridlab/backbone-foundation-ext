//! Specifications for AutomationRule aggregate
//!
...
// Each predicate implements `Specification<AutomationRule>` and can be combined
...
// impl Specification<AutomationRule> for ActiveAutomationRuleSpec {
//     fn is_satisfied_by(&self, e: &AutomationRule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
