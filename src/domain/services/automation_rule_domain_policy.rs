//! Domain policy for AutomationRule aggregate
//!
...
/// Domain policy for AutomationRule — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<AutomationRule>` on a custom
