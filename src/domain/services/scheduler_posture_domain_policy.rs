//! Domain policy for SchedulerPosture aggregate
//!
...
/// Domain policy for SchedulerPosture — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SchedulerPosture>` on a custom
